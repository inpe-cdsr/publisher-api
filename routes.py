...
# Get which satellite are in /TIFF
	...
	if basicactivity['inst'] is not None and basicactivity['inst'] not in config['publish']['SR'] and basicactivity['inst'] not in config['publish']['DN']:
